...
# Design libraries
design_libs=(processing_system7_bfm_v2_0_5 xil_defaultlib util_vector_logic_v2_0)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    ...
    "$ref_dir/../../../bd/design_1/ip/design_1_util_vector_logic_0_2/sim/design_1_util_vector_logic_0_2.vhd" \
  2>&1 | tee -a vhdlan.log
